    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.textWrap1}>
                ...
                <Text style={styles.textStyle}>● Send the product to the buyer with QR handshake</Text>
                <Text style={styles.textStyle}>● Once they scan it, you will receive your Ether</Text>
            </View>
            <View style={styles.imgWrap}>
                <Image source={introPic2} style={styles.imgStyle} />
            </View>
            <View style={styles.textWrap2}>
                <Text style={styles.textStyle}>● When your purchase arrives, scan the QR Handshake with the Hedeby App</Text>
                <Text style={styles.textStyle}>● This will authenticate that you received your purchase</Text>
                <Text style={styles.textStyle}>● The Ether is then transferred to the seller</Text>
            </View>
