    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.wrapContainer}>
                <Pressable style={styles.createWrap2} onPress={() => setScreenToShow("editinformation")}>
            ...
            <View style={styles.wrapContainer}>
                <Pressable style={styles.createWrap2} onPress={() => setScreenToShow("settingscreen")}>
                    <View style={styles.innerWrap}>
                        <View style={styles.inner}>
                            <Image
                                source={settingIcon}
