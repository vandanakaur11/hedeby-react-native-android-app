...
const TransactionScreen = ({ setScreenToShow }) => {
    return (
        <View style={styles.container}>
            ...
            <Pressable style={styles.textcont} onPress={() => setScreenToShow("transactionfilledscreen")}>
            ...
            <Pressable style={styles.textcont} onPress={() => setScreenToShow("transactiondetail")} >
...
const styles = StyleSheet.create({
    ...
    wrap: {
        ...
        paddingHorizontal: win.width / 24
    },
    heading: {
        color: "#fff",
