...
function LoginScreen({ navigation }) {
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <Text style={{ color: "white", fontSize: win.width / 12, marginBottom: 15 }}>
                Log in to continue
            </Text>
            <View style={styles.formContainer}>
                ...
                <View style={styles.btnWrap}>
                    ...
                    >
                        <Text style={{ color: "white", textAlign: "center", fontSize: win.width / 20 }}>
                            Log in
                        </Text>
                    </Pressable>
                </View>
                <Text style={{ color: "lightgrey", textAlign: "center", fontSize: win.width / 30 }}>
                    or continue with
                </Text>
